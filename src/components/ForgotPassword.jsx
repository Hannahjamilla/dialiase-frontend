...
function ForgotPassword() {
  ...
  useEffect(() => {
    ...
    const checkServer = async () => {
      ...
      if (!isConnected) {
        setApiError('Cannot connect to server. Please make sure your backend is running on ' + API_BASE_URL);
      }
    };
  ...
  const validateStep3 = () => {
    const newErrors = {};
    if (!formData.newPassword) newErrors.newPassword = "opps! Password is required";
      ...
      <header style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            padding: '0.5rem 1rem',
            borderRadius: '0.75rem',
            backgroundColor: connectionStatus === 'connected' ? '#ecfdf5' : 
                           connectionStatus === 'checking' ? '#fffbeb' : '#fef2f2',
            color: connectionStatus === 'connected' ? '#059669' : 
                   connectionStatus === 'checking' ? '#f59e0b' : '#dc2626'
          }}>
            {connectionStatus === 'checking' && <><FaServer /> Checking connection...</>}
            {connectionStatus === 'connected' && <><FaWifi /> Connected to server</>}
            {connectionStatus === 'disconnected' && (
              <><FaServer /> Disconnected <button onClick={retryConnection} style={{
                background: 'none',
                border: `1px solid ${connectionStatus === 'disconnected' ? '#dc2626' : 'currentColor'}`,
                color: 'inherit',
                ...
                <form onSubmit={handleSendOtp} style={{ marginBottom: '1.5rem' }}>
                  ...
                  <motion.button
                    ...
                    style={{
                      ...
                      alignItems: 'center',
                      justifyContent: 'center',
                      opacity: (isLoading || connectionStatus !== 'connected') ? 0.8 : 1,
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <motion.div 
                      style={{ 
                        position: 'relative',
                        borderRadius: '0.75rem',
                        border: `1px solid ${errors.otp ? '#f87171' : theme.border}`,
                        backgroundColor: theme.inputBg,
                        backdropFilter: 'blur(5px)',
                        WebkitBackdropFilter: 'blur(5px)'
                      }}
                    ...
                    >
                      <input
                        ...
                        style={{
                          width: '100%',
                          padding: windowSize.width < 768 ? '0.6rem 1rem' : '0.75rem 1rem',
                          borderRadius: '0.75rem',
                          border: 'none',
                          outline: 'none',
                          fontSize: windowSize.width < 768 ? '14px' : '16px',
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <motion.div 
                      style={{ 
                        position: 'relative',
                        borderRadius: '0.75rem',
                        border: `1px solid ${errors.newPassword ? '#f87171' : theme.border}`,
                        backgroundColor: theme.inputBg,
                        backdropFilter: 'blur(5px)',
                        WebkitBackdropFilter: 'blur(5px)'
                      }}
                      whileHover={{ 
                        borderColor: errors.newPassword ? '#f87171' : theme.accent,
                        boxShadow: `0 0 0 3px rgba(71, 121, 119, 0.1)`
                      }}
                    >
                      <FaLock style={{
                        ...
                        top: '50%',
                        transform: 'translateY(-50%)',
                        color: errors.newPassword ? '#f87171' : theme.secondaryText,
                        fontSize: windowSize.width < 768 ? '14px' : '16px'
                      }} />
                      <input
                  ...
                  <div style={{ marginBottom: '1.5rem' }}>
                    ...
                    <motion.div 
                      style={{ 
                        position: 'relative',
                        borderRadius: '0.75rem',
                        border: `1px solid ${errors.confirmPassword ? '#f87171' : theme.border}`,
                        backgroundColor: theme.inputBg,
                        backdropFilter: 'blur(5px)',
                        WebkitBackdropFilter: 'blur(5px)'
                      }}
                      whileHover={{ 
                        borderColor: errors.confirmPassword ? '#f87171' : theme.accent,
                        boxShadow: `0 0 0 3px rgba(71, 121, 119, 0.1)`
                      }}
                    >
                      <FaLock style={{
                        ...
                        top: '50%',
                        transform: 'translateY(-50%)',
                        color: errors.confirmPassword ? '#f87171' : theme.secondaryText,
                        fontSize: windowSize.width < 768 ? '14px' : '16px'
                      }} />
                      <input
